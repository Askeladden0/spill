...
(function () {
  ...
  /**
   * Setter sammen ukeslista med profilene, i samme form som buildBoards()
   * gir, slik at rangeringssiden kan tegne den med nøyaktig samme kode.
   */
  function buildWeeklyBoard(profiles, weekly) {
    const byId = new Map(weekly.map((w) => [w.user_id, w]));
    return rank(
      profiles
  ...
  window.StudillaLeaderboard = {
    games, loadProfiles, loadRecords, loadWeekly,
    buildBoards, buildWeeklyBoard, buildFriendsBoard,
